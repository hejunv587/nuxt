<template>
    <button class="flex justify-center items-center gap-2 px-7 py-4 border font-montserrat text-lg leading-none" :class="[backgroundColor
        ? [backgroundColor, textColor, borderColor].join(' ')
...
const buttonContent = `
        ${label}
        <img src="${iconURL}" alt="arrow right icon" class="ml-2 rounded-full bg-white w-5 h-5" />
      `
</script>
